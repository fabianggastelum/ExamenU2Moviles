...
class CatalogoRegalos : ComponentActivity() {
    ...
    fun cargarDetalles() {
        ...
        detalles.add(
            Detalles(
                R.drawable.regaloazul,
                "100",
            )
        )
        detalles.add(
            Detalles(
                R.drawable.regalobebe,
                "50",
            )
        )
        detalles.add(
            Detalles(
                R.drawable.regalocajas,
                "25",
            )
        )
        detalles.add(
            Detalles(
                R.drawable.regalocolores,
                "200",
            )
        )
        detalles.add(
            Detalles(
                R.drawable.regalovarios,
                "2000",
            )
        )
    }
